...
list and the signature travel in the same vehicle. 
...
```json
{
    "signatures": [
        {
         "keyid": "{base64-encoded-x509-or-pub-key-digest}",
...
The signed section is a body that contains all content that is to be signed.
...
and make progress.
-->
No immediate plan to implement signing into the tenant.
